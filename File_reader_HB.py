...
index=0
domain = os.path.abspath(r'Data/CORD-19-research-challenge/biorxiv_medrxiv')
for info in os.listdir(r'Data/CORD-19-research-challenge/biorxiv_medrxiv'):
    ...
    with open(info, 'r') as f:
        ...
        with open(str(index)+'.csv', 'w', newline='') as csvfile:
            ...
            for line in f:
                ...
                csvwriter.writerow(list(dic.values()))
        csvfile.close()
    f.close()
